...
import org.pgpvault.gui.tools.osnative.OsNative;
import org.pgpvault.gui.tools.osnative.OsNativeFactory;
...
public class EntryPoint {
	...
	private static OsNative osNative;
	...
	public static void main(String[] args) {
		...
		try {
			osNative = OsNativeFactory.build();
			args = osNative.getCommandLineArguments(args);
